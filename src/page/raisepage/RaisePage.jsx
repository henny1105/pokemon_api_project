...
import styles from './RaisePage.module.css';

const RaisePage = () => {
	return (
		<div className={`${styles.containerFluidCustom} ${styles.bgPrimaryCustom}`}>
			<div className='bg-white-custom raise-area'>
				...
				<div className='row-custom'>
					<div className='col-6-custom center pokemon-info'>
						<img className='pokemon-img-custom' src='https://i.namu.wiki/i/l0x04r27DjSQmS-WgYk6I5x6IkKMyvZjRMyK5dI3EMoMikzCd2Kfl2SMRdvL3-y4zpxI_qLP-fs3QToSR7AU3g.webp' alt='pokemon' />
						<div className='w-80'>LV.1</div>
						<div className='w-80 '>
							<div>exp 1/30</div>
							<div className='progress-bar'></div>
						</div>
						<div className='w-80'>속성</div>
					</div>
					<div className='col-6 center button-section-custom'>
