...
const PokemonBattlePage = () => {
	...
	return (
		...
		>
			...
			<div className='battle-message-container'>
				<div className='battle-message'>
					...
					<div className='battle-btns'>
						<button className='battle-attack-btn' onClick={() => attack()}>
							공격한다.
						</button>
			...
			<Modal isOpen={modalIsOpen} onRequestClose={closeModal} style={customStyles} contentLabel='알림' className='battle-modal'>
