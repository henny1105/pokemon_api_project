    ...
    return (
        <div className='battle-card'>
            ...
            <div className='battle-card-image-container'>
                <img className="battle-card-image" src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/black-white/animated/132.gif" alt="" />
            </div>
        </div>
    )
}
