...
const MyPokemonPage = () => {
  ...
  return (
    <div className='container-fluid-custom bg-primary-custom'>
      <div className='bg-white-custom my-pokemon-area'>
        ...
        <div className='row-custom'>
          ...
          <div className='col-custom my-info-area'>
            ...
            <div className='row-custom'>
              ...
              <div className='col-custom'>
                <div className='pokemon-card-area body_3'>
                  ...
                  <img className='my-pokemon-img' src="https://i.namu.wiki/i/l0x04r27DjSQmS-WgYk6I5x6IkKMyvZjRMyK5dI3EMoMikzCd2Kfl2SMRdvL3-y4zpxI_qLP-fs3QToSR7AU3g.webp" alt="pokemon" />
